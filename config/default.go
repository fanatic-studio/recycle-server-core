...
import (
	...
	"github.com/fanatic-studio/recycle-server-core/config/loader"
	"github.com/fanatic-studio/recycle-server-core/config/loader/memory"
	"github.com/fanatic-studio/recycle-server-core/config/reader"
	"github.com/fanatic-studio/recycle-server-core/config/reader/json"
	"github.com/fanatic-studio/recycle-server-core/config/source"
)
